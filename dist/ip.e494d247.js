...
function yeniÖzellik(obje) {
  ...
  var kartBilgi = document.createElement("div");
  kartBilgi.classList.add("card-info");
  kart.appendChild(kartBilgi);
  var IP = document.createElement("h");
  IP.className = "ip";
  IP.textContent = obje.sorgu;
  kartBilgi.appendChild(IP);
  var paragraf = document.createElement("p");
  paragraf.className = "ulke";
  paragraf.textContent = "".concat(obje.ülke, "(").concat(obje.ülkeKodu, ")");
  kartBilgi.appendChild(paragraf);
  var paragrafEnlem = document.createElement("p");
  paragrafEnlem.textContent = "Enlem:".concat(obje.enlem, " Boylam:").concat(obje.boylam);
  kartBilgi.appendChild(paragrafEnlem);
  var paragrafSehir = document.createElement("p");
  paragrafSehir.textContent = "\u015Eehir:".concat(obje.şehir);
  kartBilgi.appendChild(paragrafSehir);
  var saat = document.createElement("p");
  saat.textContent = "Saat dilimi:".concat(obje.saatdilimi);
  kartBilgi.appendChild(saat);
  var para = document.createElement("p");
  para.textContent = "Para birimi:".concat(obje.parabirimi);
  kartBilgi.appendChild(para);
  var sonParagraf = document.createElement("p");
  sonParagraf.textContent = "ISP:".concat(obje.isp);
  return kart;
}
var objeyiGetir = /*#__PURE__*/function () {
